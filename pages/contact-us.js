    ...
    <>
      <div className="contact-us-container">
        ...
        <div className="contact-us-container1">
          <nav data-role="Header" className="contact-us-navbar">
            <h1>FANTASISTUDIO</h1>
            <div className="contact-us-right-side">
              <div className="contact-us-links-container">
                <Link href="/">
                  <a className="contact-us-link">Home</a>
                </Link>
                <Link href="/privat-for-gs">
                  <a className="contact-us-link01">Privat for G&apos;s</a>
                </Link>
                <Link href="/dopa">
                  <a className="contact-us-link02">
                    <span>DOPA</span>
                    <br></br>
                  </a>
                </Link>
                <Link href="/siddemaal">
                  <a className="contact-us-link03">
                    <span>SIDDEMAAL</span>
                    <br></br>
                  </a>
                </Link>
                <Link href="/side-projects">
                  <a className="contact-us-link05">Side Projects</a>
                </Link>
              </div>
            ...
            <div data-role="BurgerMenu" className="contact-us-burger-menu">
              <svg viewBox="0 0 1024 1024" className="contact-us-burger-menu">
            ...
            <div data-role="MobileMenu" className="contact-us-mobile-menu">
              <div className="contact-us-nav">
                <div className="contact-us-top">
                  ...
                  >
                    <svg viewBox="0 0 1024 1024" className="contact-us-icon03">
                      <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                    </svg>
                  </div>
                </div>
                <div className="contact-us-right-side1">
                  <div className="contact-us-links-container1">
                    <span className="contact-us-text4">Home</span>
                    <span className="contact-us-text5">About</span>
                    <span className="contact-us-text6">Tour Packages</span>
                    <span>Contact</span>
                  </div>
                  <a href="#main-section" className="contact-us-link06">
                    <SolidButtoncontactus Contact_Us="Explore places"></SolidButtoncontactus>
                  </a>
                </div>
              </div>
              <div className="contact-us-follow-container">
                <span className="contact-us-text8">
                  Follow us on
                  <span
                ...
                <div className="contact-us-icons-container">
                  <a
                    ...
                    className="contact-us-link07"
                  >
                    <svg
                      viewBox="0 0 877.7142857142857 1024"
                      className="contact-us-icon05"
                    >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer noopener"
                    className="contact-us-link08"
                  >
                    <svg
                      viewBox="0 0 602.2582857142856 1024"
                      className="contact-us-icon07"
                    >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer noopener"
                    className="contact-us-link09"
                  >
                    <svg
                      viewBox="0 0 950.8571428571428 1024"
                      className="contact-us-icon09"
                    >
